          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  'flex flex-col items-center justify-center gap-1 rounded-full p-2 text-xs font-medium transition-colors w-16 h-16',
                  !isActive && 'text-muted-foreground hover:bg-muted/50'
                )}
              >
                <div className={cn(
                    'flex h-8 w-12 items-center justify-center rounded-full text-2xl',
